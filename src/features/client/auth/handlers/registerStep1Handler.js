...
const messages = {
  numberNotRegistered: "We couldn't find an invitation for this phone number. Please check the number and try again.",
  error: "Something went wrong. Please try again.",
  success: "We've sent a one-time password to your phone number which will expire in 5 minutes."
};

const createOneTimePassword = async () => {
  // TODO: Replace with actual OTP generation
